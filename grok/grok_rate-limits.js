// ==UserScript==
// @name         Grok Rate Limits Display
// @name:el      Εμφάνιση ορίων χρήσης για το Grok
...
// @icon         https://grok.com/images/favicon-dark.png
// @updateURL    https://raw.githubusercontent.com/CarpeNoctemXD/UserScripts/refs/heads/main/grok/grok_rate-limits.js
// @downloadURL  https://raw.githubusercontent.com/CarpeNoctemXD/UserScripts/refs/heads/main/grok/grok_rate-limits.js
// @license      MIT
// @grant        none
// ==/UserScript==
...
(function () {
  ...
  function updateRateInfo(data, modelName, requestKind = "DEFAULT") {
    ...
    for (const kind of ["DEFAULT", "REASONING", "DEEPSEARCH", "DEEPERSEARCH"]) {
      ...
      lines.push(`<span style="background:${bg};color:${color};font-weight:bold;padding:0 0.25em;border-radius:0.25em;">
          ${displayName}: ${remaining}/${total}
          <span style="color:#0f0f0f;font-size:0.75em;">(${timeStr})</span>
      </span>`);
    }
